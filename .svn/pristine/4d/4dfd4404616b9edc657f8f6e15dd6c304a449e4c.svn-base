package cn.lyj.core.service.user;
...
import cn.lyj.core.bean.user.Employee;
import cn.lyj.core.dao.user.EmployeeDao;
import cn.lyj.core.query.user.EmployeeQuery;
/**
 * 员工
 * @author lixu
