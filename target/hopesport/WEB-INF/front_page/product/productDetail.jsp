...
<div class="w ofc mt">
	...
	<div class="r" style="width: 640px">
		<ul class="uls form">
			<li><h2>${producr.name }</h2></li>
			<li><label>售      价：</label><span class="word"><b class="f14 red mr" id="price">￥128.00</b>(市场价:<del id="mprice">￥150.00</del>)</span></li>
			...
			<li><label>选择颜色：</label>
				<div id="colors" class="pre spec">
					...
					<a onclick="colorToRed(this,${color.id})" href="javascript:void(0)" title="${color.name }" class="changToWhite"><img width="25" height="25" data-img="1" src="${color.name }" alt="${color.name }"><i>${color.name }</i></a>
					</c:forEach>
				</div>
			</li>
			<li id="sizes"><label>尺　　码：</label>
						<a href="javascript:void(0)" class="not-allow"  id="S" onclick="size2Red(this,'S')">S</a>
						<a href="javascript:void(0)" class="not-allow"  id="M" onclick="size2Red(this,'M')">M</a>
						<a href="javascript:void(0)" class="not-allow"  id="L" onclick="size2Red(this,'L')">L</a>
						<a href="javascript:void(0)" class="not-allow"  id="XL" onclick="size2Red(this,'XL')">XL</a>
						<a href="javascript:void(0)" class="not-allow"  id="XXL" onclick="size2Red(this,'XXL')">XXL</a>
			</li>
